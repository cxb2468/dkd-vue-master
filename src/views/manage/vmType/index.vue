    ...
    <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      <el-form ref="vmTypeRef" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="货道行" prop="vmRow">
          <el-input-number v-model="form.vmRow" placeholder="请输入货道行" style="width: 120px" :max="10" :min="1" />行
          &nbsp;&nbsp;
          <el-input-number v-model="form.vmCol" placeholder="请输入货道列" style="width: 120px" :max="10" :min="1" />列
        </el-form-item>
        <el-form-item label="设备容量" prop="channelMaxCapacity">
          <el-input-number v-model="form.channelMaxCapacity" placeholder="请输入设备容量" style="width: 120px" :max="10" :min="1" />个
        </el-form-item>
