<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="所属区域" prop="regionId" label-width="100px">
        <el-select v-model="queryParams.regionId" placeholder="请选择所属区域" style="width: 150px" clearable > 
          <el-option
      ...
      <el-form-item label="角色id" prop="roleId">
        <!-- <el-input
          ...
          @keyup.enter="handleQuery"
        /> -->
        <el-select v-model="queryParams.roleId" placeholder="请选择角色"  style="width: 150px" clearable> 
          <el-option
    ...
    <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      <el-form ref="empRef" :model="form" :rules="rules" label-width="100px">
        ...
        <el-form-item label="所属区域Id" prop="regionId">
          ...
          <el-select v-model="form.regionId" placeholder="请选择所属区域Id"> 
            <el-option
              v-for="item in regionList"
              :key="item.id"
              :label="item.regionName"
...
<!--           <el-input v-model="form.roleId" placeholder="请输入角色id" /> -->
        ...
        <!-- 显示创建日期 -->
         <el-form-item label="创建日期" prop="createTime" v-if="form.id!=null">
          {{ form.createTime }}
        </el-form-item>
